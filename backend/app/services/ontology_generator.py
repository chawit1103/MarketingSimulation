...
class OntologyGenerator:
    ...
    def __init__(self, llm_client: Optional[Any] = None, language: str = 'en'):
        self.llm_client = llm_client or LLMProviderFactory.get_provider('ontology')
    ...
    def generate(
        ...
        Args:
            ...
            language: Language code for prompts ('en', 'th', 'zh'). Overrides constructor default.
        ...
        messages = [
            {"role": "system", "content": PromptManager.get_prompt('ontology_system', effective_language)},
