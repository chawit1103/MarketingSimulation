...
describe('ResourcesHub', () => {
  ...
  it('organizes curated documentation links without duplicating full docs', () => {
    ...
    expect(hrefs).toContain('https://github.com/chawit1103/MarketingSimulation/blob/multilang-v0.3/docs/strategic-command/PM25_CANVA_SLIDE_STORYBOARD_TH.md')
    expect(hrefs).toContain('https://github.com/chawit1103/MarketingSimulation/blob/multilang-v0.3/docs/strategic-command/PM25_CANVA_DESIGN_GUIDE_TH.md')
    expect(hrefs).toContain('https://github.com/chawit1103/MarketingSimulation/blob/multilang-v0.3/docs/strategic-command/PM25_SHORT_VIDEO_SCRIPT_TH.md')
    expect(hrefs).toContain('https://github.com/chawit1103/MarketingSimulation/blob/multilang-v0.3/docs/strategic-command/PM25_FOLLOW_UP_EMAIL_TH.md')
